...
expected_fields = {
    ...
    "dns-record-type": "services[0].check.record_type",
    ...
    "ping-packet-loss": "services[0].check.max_packet_loss_percent",
    "remote-http-method": "services[0].actions.http[0].method",
